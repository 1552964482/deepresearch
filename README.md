...
> **完整规格：** [`.kiro/specs/deepresearch-multiagent/`](./.kiro/specs/deepresearch-multiagent)
...
- 需求与验收：[`.kiro/specs/deepresearch-multiagent/requirements.md`](./.kiro/specs/deepresearch-multiagent/requirements.md)
- 设计与组件接口：[`.kiro/specs/deepresearch-multiagent/design.md`](./.kiro/specs/deepresearch-multiagent/design.md)
- 实现任务清单：[`.kiro/specs/deepresearch-multiagent/tasks.md`](./.kiro/specs/deepresearch-multiagent/tasks.md)
